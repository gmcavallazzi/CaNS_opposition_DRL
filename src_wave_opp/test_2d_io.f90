...
contains
  ...
  subroutine test_2d_slice_io(datadir, ipencil, n, ng, w)
    ...
    call MPI_FILE_OPEN(MPI_COMM_WORLD, fname_orig, MPI_MODE_RDONLY, MPI_INFO_NULL, fh, ierr)
    ...
    call MPI_FILE_OPEN(MPI_COMM_WORLD, fname_test, MPI_MODE_CREATE+MPI_MODE_WRONLY, MPI_INFO_NULL, fh, ierr)
